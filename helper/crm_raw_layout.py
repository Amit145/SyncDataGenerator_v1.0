CRM_RAW_FILE_MAP = {
    "crm_person.csv": "party_master.csv",
    "crm_contact.csv": "contact_point.csv",
    "crm_identity.csv": "identity_registry.csv",
    "crm_person_address.csv": "address_book.csv",
    "crm_lead.csv": "lead_register.csv",
    "crm_customer.csv": "customer_portfolio.csv",
    "crm_customer_lead.csv": "customer_lead_bridge.csv",
    "crm_consent.csv": "consent_snapshot.csv",
    "crm_marketing_preference.csv": "comm_preference.csv",
    "crm_marketing_engagement.csv": "campaign_touch.csv",
    "crm_account.csv": "account_book.csv",
    "crm_product.csv": "product_catalog.csv",
    "crm_quote.csv": "quote_register.csv",
    "crm_policy.csv": "policy_register.csv",
    "crm_home.csv": "property_asset.csv",
    "crm_motor.csv": "vehicle_asset.csv",
}
...
CRM_RAW_COLUMN_MAP = {
    ...
    "claims_is_lead": "is_lead",
    "claims_person_type": "person_type",
    "claims_person_status": "person_status",
    "claims_preferred_language": "preferred_language",
    "claims_source_type": "source_type",
    "tenant_identifier": "tenant_identifier",
    "source_identifier": "source_identifier",
    "assessed_disability_degree": "assessed_disability_degree",
    "is_operational_paperless_consent": "is_operational_paperless_consent",
    "is_opt_in_legitimate_interest": "is_opt_in_legitimate_interest",
    "is_opt_in_validated": "is_opt_in_validated",
    "digital_identifier": "digital_identifier",
    "identification_type": "identification_type",
    "legal_consent_flag": "legal_consent_flag",
    "credit_rating": "credit_rating",
    "rate_class": "rate_class",
    "credit_rating_provider": "credit_rating_provider",
    ...
    "customer_onboarding_satisfaction_score": "customer_onboarding_satisfaction_score",
    "customer_onboarding_feedback": "customer_onboarding_feedback",
    ...
    "has_retention_team_interaction": "has_retention_team_interaction",
    "customer_service_call_frequency": "customer_service_call_frequency",
    "average_call_sentiment": "average_call_sentiment",
    ...
    "quote_month_name": "quote_month_name",
    "risk_score": "risk_score",
    "policy_complexity": "policy_complexity",
    "uw_approval_type": "uw_approval_type",
    ...
    "no_claims_discount_years": "no_claims_discount_years",
    "payment_method": "payment_method",
    "is_direct_debit_cancellation": "is_direct_debit_cancellation",
    "missed_payment_count": "missed_payment_count",
    "loyalty_discount_usage": "loyalty_discount_usage",
    "is_installment_default": "is_installment_default",
    "policy_renewal_satisfaction_score": "policy_renewal_satisfaction_score",
    "policy_renewal_feedback": "policy_renewal_feedback",
    "is_renewal_escalation": "is_renewal_escalation",

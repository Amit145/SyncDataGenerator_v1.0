...
SELECT DISTINCT
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(party_ref AS TEXT)), ''))) AS person_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    NULLIF(TRIM(CAST(party_ref AS TEXT)), '') AS person_id
FROM crm_party_master_csv
WHERE NULLIF(TRIM(CAST(party_ref AS TEXT)), '') IS NOT NULL
UNION ALL
SELECT DISTINCT
    MD5(CONCAT('SAP|', NULLIF(TRIM(CAST(person_id AS TEXT)), ''))) AS person_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'SAP' AS record_source,
    NULLIF(TRIM(CAST(person_id AS TEXT)), '') AS person_id
FROM sap_person_db
WHERE NULLIF(TRIM(CAST(person_id AS TEXT)), '') IS NOT NULL;
...
SELECT DISTINCT
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(natural_ref AS TEXT)), ''))) AS natural_person_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    NULLIF(TRIM(CAST(natural_ref AS TEXT)), '') AS natural_person_id
FROM crm_party_master_csv
WHERE NULLIF(TRIM(CAST(natural_ref AS TEXT)), '') IS NOT NULL
UNION ALL
SELECT DISTINCT
    MD5(CONCAT('SAP|', NULLIF(TRIM(CAST(person_id AS TEXT)), ''))) AS natural_person_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'SAP' AS record_source,
    NULLIF(TRIM(CAST(person_id AS TEXT)), '') AS natural_person_id
FROM sap_person_db
WHERE NULLIF(TRIM(CAST(person_id AS TEXT)), '') IS NOT NULL AND UPPER(person_type) = 'NATURAL';
...
SELECT DISTINCT
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(legal_ref AS TEXT)), ''))) AS legal_person_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    NULLIF(TRIM(CAST(legal_ref AS TEXT)), '') AS legal_person_id
FROM crm_party_master_csv
WHERE NULLIF(TRIM(CAST(legal_ref AS TEXT)), '') IS NOT NULL
UNION ALL
SELECT DISTINCT
    MD5(CONCAT('SAP|', NULLIF(TRIM(CAST(person_id AS TEXT)), ''))) AS legal_person_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'SAP' AS record_source,
    NULLIF(TRIM(CAST(person_id AS TEXT)), '') AS legal_person_id
FROM sap_person_db
WHERE NULLIF(TRIM(CAST(person_id AS TEXT)), '') IS NOT NULL AND UPPER(person_type) = 'LEGAL';
...
SELECT DISTINCT
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(contact_ref AS TEXT)), ''))) AS contact_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    NULLIF(TRIM(CAST(contact_ref AS TEXT)), '') AS contact_id
FROM crm_contact_point_csv
WHERE NULLIF(TRIM(CAST(contact_ref AS TEXT)), '') IS NOT NULL;
...
SELECT DISTINCT
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(identity_ref AS TEXT)), ''))) AS identities_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    NULLIF(TRIM(CAST(identity_ref AS TEXT)), '') AS identities_id
FROM crm_identity_registry_csv
WHERE NULLIF(TRIM(CAST(identity_ref AS TEXT)), '') IS NOT NULL;
...
SELECT DISTINCT
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(address_ref AS TEXT)), ''))) AS address_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    NULLIF(TRIM(CAST(address_ref AS TEXT)), '') AS address_id
FROM crm_address_book_csv
WHERE NULLIF(TRIM(CAST(address_ref AS TEXT)), '') IS NOT NULL
UNION ALL
SELECT DISTINCT
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_address_id AS TEXT)), ''))) AS address_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    NULLIF(TRIM(CAST(src_address_id AS TEXT)), '') AS address_id
FROM crm_enhanced_address_book_csv
WHERE NULLIF(TRIM(CAST(src_address_id AS TEXT)), '') IS NOT NULL
UNION ALL
SELECT DISTINCT
    MD5(CONCAT('SAP|', NULLIF(TRIM(CAST(address_id AS TEXT)), ''))) AS address_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'SAP' AS record_source,
    NULLIF(TRIM(CAST(address_id AS TEXT)), '') AS address_id
FROM sap_address_db
WHERE NULLIF(TRIM(CAST(address_id AS TEXT)), '') IS NOT NULL;
...
SELECT DISTINCT
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(consent_ref AS TEXT)), ''))) AS consent_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    NULLIF(TRIM(CAST(consent_ref AS TEXT)), '') AS consent_id
FROM crm_consent_snapshot_csv
WHERE NULLIF(TRIM(CAST(consent_ref AS TEXT)), '') IS NOT NULL;
...
SELECT DISTINCT
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(preference_ref AS TEXT)), ''))) AS marketing_preference_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    NULLIF(TRIM(CAST(preference_ref AS TEXT)), '') AS marketing_preference_id
FROM crm_comm_preference_csv
WHERE NULLIF(TRIM(CAST(preference_ref AS TEXT)), '') IS NOT NULL;
...
SELECT DISTINCT
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(engagement_ref AS TEXT)), ''))) AS marketing_engagement_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    NULLIF(TRIM(CAST(engagement_ref AS TEXT)), '') AS marketing_engagement_id
FROM crm_campaign_touch_csv
WHERE NULLIF(TRIM(CAST(engagement_ref AS TEXT)), '') IS NOT NULL;
...
SELECT DISTINCT
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(lead_ref AS TEXT)), ''))) AS lead_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    NULLIF(TRIM(CAST(lead_ref AS TEXT)), '') AS lead_id
FROM crm_lead_register_csv
WHERE NULLIF(TRIM(CAST(lead_ref AS TEXT)), '') IS NOT NULL;
...
SELECT DISTINCT
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(quote_ref AS TEXT)), ''))) AS quote_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    NULLIF(TRIM(CAST(quote_ref AS TEXT)), '') AS quote_id
FROM crm_quote_register_csv
WHERE NULLIF(TRIM(CAST(quote_ref AS TEXT)), '') IS NOT NULL;
...
SELECT DISTINCT
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(policy_ref AS TEXT)), ''))) AS policy_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    NULLIF(TRIM(CAST(policy_ref AS TEXT)), '') AS policy_id
FROM crm_policy_register_csv
WHERE NULLIF(TRIM(CAST(policy_ref AS TEXT)), '') IS NOT NULL
UNION ALL
SELECT DISTINCT
    MD5(CONCAT('SAP|', NULLIF(TRIM(CAST(policy_id AS TEXT)), ''))) AS policy_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'SAP' AS record_source,
    NULLIF(TRIM(CAST(policy_id AS TEXT)), '') AS policy_id
FROM sap_home_db
WHERE NULLIF(TRIM(CAST(policy_id AS TEXT)), '') IS NOT NULL
UNION ALL
SELECT DISTINCT
    MD5(CONCAT('SAP|', NULLIF(TRIM(CAST(policy_id AS TEXT)), ''))) AS policy_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
...
SELECT DISTINCT
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(account_ref AS TEXT)), ''))) AS account_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    NULLIF(TRIM(CAST(account_ref AS TEXT)), '') AS account_id
FROM crm_account_book_csv
WHERE NULLIF(TRIM(CAST(account_ref AS TEXT)), '') IS NOT NULL;
...
SELECT DISTINCT
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(customer_ref AS TEXT)), ''))) AS customer_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    NULLIF(TRIM(CAST(customer_ref AS TEXT)), '') AS customer_id
FROM crm_customer_portfolio_csv
WHERE NULLIF(TRIM(CAST(customer_ref AS TEXT)), '') IS NOT NULL;
...
SELECT DISTINCT
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(product_ref AS TEXT)), ''))) AS product_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    NULLIF(TRIM(CAST(product_ref AS TEXT)), '') AS product_id
FROM crm_product_catalog_csv
WHERE NULLIF(TRIM(CAST(product_ref AS TEXT)), '') IS NOT NULL
UNION ALL
SELECT DISTINCT
    MD5(CONCAT('SAP|', NULLIF(TRIM(CAST(product_id AS TEXT)), ''))) AS product_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'SAP' AS record_source,
    NULLIF(TRIM(CAST(product_id AS TEXT)), '') AS product_id
FROM sap_product_db
WHERE NULLIF(TRIM(CAST(product_id AS TEXT)), '') IS NOT NULL
UNION ALL
SELECT DISTINCT
    MD5(CONCAT('SAP|', NULLIF(TRIM(CAST(product_id AS TEXT)), ''))) AS product_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
...
SELECT DISTINCT
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(vehicle_ref AS TEXT)), ''))) AS motor_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    NULLIF(TRIM(CAST(vehicle_ref AS TEXT)), '') AS motor_id
FROM crm_vehicle_asset_csv
WHERE NULLIF(TRIM(CAST(vehicle_ref AS TEXT)), '') IS NOT NULL
UNION ALL
SELECT DISTINCT
    MD5(CONCAT('SAP|', NULLIF(TRIM(CAST(motor_id AS TEXT)), ''))) AS motor_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'SAP' AS record_source,
    NULLIF(TRIM(CAST(motor_id AS TEXT)), '') AS motor_id
FROM sap_motor_db
WHERE NULLIF(TRIM(CAST(motor_id AS TEXT)), '') IS NOT NULL;
...
SELECT DISTINCT
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(property_ref AS TEXT)), ''))) AS home_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    NULLIF(TRIM(CAST(property_ref AS TEXT)), '') AS home_id
FROM crm_property_asset_csv
WHERE NULLIF(TRIM(CAST(property_ref AS TEXT)), '') IS NOT NULL
UNION ALL
SELECT DISTINCT
    MD5(CONCAT('SAP|', NULLIF(TRIM(CAST(home_id AS TEXT)), ''))) AS home_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'SAP' AS record_source,
    NULLIF(TRIM(CAST(home_id AS TEXT)), '') AS home_id
FROM sap_home_db
WHERE NULLIF(TRIM(CAST(home_id AS TEXT)), '') IS NOT NULL;
...
SELECT DISTINCT
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_agent_id AS TEXT)), ''))) AS broker_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    NULLIF(TRIM(CAST(src_agent_id AS TEXT)), '') AS agent_id
FROM crm_broker_book_csv
WHERE NULLIF(TRIM(CAST(src_agent_id AS TEXT)), '') IS NOT NULL;
...
SELECT DISTINCT
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_campaign_id AS TEXT)), ''))) AS campaign_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    NULLIF(TRIM(CAST(src_campaign_id AS TEXT)), '') AS campaign_id
FROM crm_campaign_register_csv
WHERE NULLIF(TRIM(CAST(src_campaign_id AS TEXT)), '') IS NOT NULL;
...
SELECT DISTINCT
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_channel_id AS TEXT)), ''))) AS channel_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    NULLIF(TRIM(CAST(src_channel_id AS TEXT)), '') AS channel_id
FROM crm_channel_catalog_csv
WHERE NULLIF(TRIM(CAST(src_channel_id AS TEXT)), '') IS NOT NULL;
...
SELECT DISTINCT
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_claim_id AS TEXT)), ''))) AS claim_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    NULLIF(TRIM(CAST(src_claim_id AS TEXT)), '') AS claim_id
FROM crm_claim_register_csv
WHERE NULLIF(TRIM(CAST(src_claim_id AS TEXT)), '') IS NOT NULL;
...
SELECT DISTINCT
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_complaint_id AS TEXT)), ''))) AS complaint_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    NULLIF(TRIM(CAST(src_complaint_id AS TEXT)), '') AS complaint_id
FROM crm_complaint_register_csv
WHERE NULLIF(TRIM(CAST(src_complaint_id AS TEXT)), '') IS NOT NULL;
...
SELECT DISTINCT
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(insured_object_id AS TEXT)), ''))) AS insured_object_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    NULLIF(TRIM(CAST(insured_object_id AS TEXT)), '') AS insured_object_id
FROM crm_property_asset_csv
WHERE NULLIF(TRIM(CAST(insured_object_id AS TEXT)), '') IS NOT NULL
UNION ALL
SELECT DISTINCT
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(insured_object_id AS TEXT)), ''))) AS insured_object_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
...
SELECT DISTINCT
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_override_id AS TEXT)), ''))) AS override_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    NULLIF(TRIM(CAST(src_override_id AS TEXT)), '') AS override_id
FROM crm_override_register_csv
WHERE NULLIF(TRIM(CAST(src_override_id AS TEXT)), '') IS NOT NULL;
...
SELECT DISTINCT
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_regulation_id AS TEXT)), ''))) AS regulation_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    NULLIF(TRIM(CAST(src_regulation_id AS TEXT)), '') AS regulation_id
FROM crm_regulation_register_csv
WHERE NULLIF(TRIM(CAST(src_regulation_id AS TEXT)), '') IS NOT NULL;
...
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(party_ref AS TEXT)), ''))), MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(natural_ref AS TEXT)), ''))))) AS person_natural_person_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(party_ref AS TEXT)), ''))) AS person_hash_key,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(natural_ref AS TEXT)), ''))) AS natural_person_hash_key
FROM crm_party_master_csv
WHERE NULLIF(TRIM(CAST(party_ref AS TEXT)), '') IS NOT NULL AND NULLIF(TRIM(CAST(natural_ref AS TEXT)), '') IS NOT NULL AND 1=1
UNION ALL
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('SAP|', NULLIF(TRIM(CAST(person_id AS TEXT)), ''))), MD5(CONCAT('SAP|', NULLIF(TRIM(CAST(person_id AS TEXT)), ''))))) AS person_natural_person_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'SAP' AS record_source,
    MD5(CONCAT('SAP|', NULLIF(TRIM(CAST(person_id AS TEXT)), ''))) AS person_hash_key,
    MD5(CONCAT('SAP|', NULLIF(TRIM(CAST(person_id AS TEXT)), ''))) AS natural_person_hash_key
FROM sap_person_db
WHERE NULLIF(TRIM(CAST(person_id AS TEXT)), '') IS NOT NULL AND NULLIF(TRIM(CAST(person_id AS TEXT)), '') IS NOT NULL AND UPPER(person_type) = 'NATURAL';
...
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(party_ref AS TEXT)), ''))), MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(legal_ref AS TEXT)), ''))))) AS person_legal_person_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(party_ref AS TEXT)), ''))) AS person_hash_key,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(legal_ref AS TEXT)), ''))) AS legal_person_hash_key
FROM crm_party_master_csv
WHERE NULLIF(TRIM(CAST(party_ref AS TEXT)), '') IS NOT NULL AND NULLIF(TRIM(CAST(legal_ref AS TEXT)), '') IS NOT NULL AND 1=1
UNION ALL
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('SAP|', NULLIF(TRIM(CAST(person_id AS TEXT)), ''))), MD5(CONCAT('SAP|', NULLIF(TRIM(CAST(person_id AS TEXT)), ''))))) AS person_legal_person_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'SAP' AS record_source,
    MD5(CONCAT('SAP|', NULLIF(TRIM(CAST(person_id AS TEXT)), ''))) AS person_hash_key,
    MD5(CONCAT('SAP|', NULLIF(TRIM(CAST(person_id AS TEXT)), ''))) AS legal_person_hash_key
FROM sap_person_db
WHERE NULLIF(TRIM(CAST(person_id AS TEXT)), '') IS NOT NULL AND NULLIF(TRIM(CAST(person_id AS TEXT)), '') IS NOT NULL AND UPPER(person_type) = 'LEGAL';
...
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(party_ref AS TEXT)), ''))), MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(contact_ref AS TEXT)), ''))))) AS person_contact_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(party_ref AS TEXT)), ''))) AS person_hash_key,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(contact_ref AS TEXT)), ''))) AS contact_hash_key
FROM crm_contact_point_csv
WHERE NULLIF(TRIM(CAST(party_ref AS TEXT)), '') IS NOT NULL AND NULLIF(TRIM(CAST(contact_ref AS TEXT)), '') IS NOT NULL AND 1=1;
...
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(party_ref AS TEXT)), ''))), MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(identity_ref AS TEXT)), ''))))) AS person_identities_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(party_ref AS TEXT)), ''))) AS person_hash_key,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(identity_ref AS TEXT)), ''))) AS identities_hash_key
FROM crm_identity_registry_csv
WHERE NULLIF(TRIM(CAST(party_ref AS TEXT)), '') IS NOT NULL AND NULLIF(TRIM(CAST(identity_ref AS TEXT)), '') IS NOT NULL AND 1=1;
...
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(party_ref AS TEXT)), ''))), MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(address_ref AS TEXT)), ''))))) AS person_address_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(party_ref AS TEXT)), ''))) AS person_hash_key,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(address_ref AS TEXT)), ''))) AS address_hash_key
FROM crm_address_book_csv
WHERE NULLIF(TRIM(CAST(party_ref AS TEXT)), '') IS NOT NULL AND NULLIF(TRIM(CAST(address_ref AS TEXT)), '') IS NOT NULL AND 1=1
UNION ALL
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_person_id AS TEXT)), ''))), MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_address_id AS TEXT)), ''))))) AS person_address_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_person_id AS TEXT)), ''))) AS person_hash_key,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_address_id AS TEXT)), ''))) AS address_hash_key
FROM crm_enhanced_person_relationships_csv
WHERE NULLIF(TRIM(CAST(src_person_id AS TEXT)), '') IS NOT NULL AND NULLIF(TRIM(CAST(src_address_id AS TEXT)), '') IS NOT NULL AND source_extract = 'person_address_bridge.csv'
UNION ALL
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('SAP|', NULLIF(TRIM(CAST(person_id AS TEXT)), ''))), MD5(CONCAT('SAP|', NULLIF(TRIM(CAST(address_id AS TEXT)), ''))))) AS person_address_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'SAP' AS record_source,
    MD5(CONCAT('SAP|', NULLIF(TRIM(CAST(person_id AS TEXT)), ''))) AS person_hash_key,
    MD5(CONCAT('SAP|', NULLIF(TRIM(CAST(address_id AS TEXT)), ''))) AS address_hash_key
FROM sap_address_db
WHERE NULLIF(TRIM(CAST(person_id AS TEXT)), '') IS NOT NULL AND NULLIF(TRIM(CAST(address_id AS TEXT)), '') IS NOT NULL AND 1=1;
...
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(party_ref AS TEXT)), ''))), MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(consent_ref AS TEXT)), ''))))) AS person_consent_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(party_ref AS TEXT)), ''))) AS person_hash_key,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(consent_ref AS TEXT)), ''))) AS consent_hash_key
FROM crm_consent_snapshot_csv
WHERE NULLIF(TRIM(CAST(party_ref AS TEXT)), '') IS NOT NULL AND NULLIF(TRIM(CAST(consent_ref AS TEXT)), '') IS NOT NULL AND 1=1;
...
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(party_ref AS TEXT)), ''))), MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(preference_ref AS TEXT)), ''))))) AS person_marketing_preference_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(party_ref AS TEXT)), ''))) AS person_hash_key,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(preference_ref AS TEXT)), ''))) AS marketing_preference_hash_key
FROM crm_comm_preference_csv
WHERE NULLIF(TRIM(CAST(party_ref AS TEXT)), '') IS NOT NULL AND NULLIF(TRIM(CAST(preference_ref AS TEXT)), '') IS NOT NULL AND 1=1;
...
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(party_ref AS TEXT)), ''))), MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(engagement_ref AS TEXT)), ''))))) AS person_marketing_engagement_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(party_ref AS TEXT)), ''))) AS person_hash_key,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(engagement_ref AS TEXT)), ''))) AS marketing_engagement_hash_key
FROM crm_campaign_touch_csv
WHERE NULLIF(TRIM(CAST(party_ref AS TEXT)), '') IS NOT NULL AND NULLIF(TRIM(CAST(engagement_ref AS TEXT)), '') IS NOT NULL AND 1=1;
...
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(party_ref AS TEXT)), ''))), MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(lead_ref AS TEXT)), ''))))) AS person_lead_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(party_ref AS TEXT)), ''))) AS person_hash_key,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(lead_ref AS TEXT)), ''))) AS lead_hash_key
FROM crm_lead_register_csv
WHERE NULLIF(TRIM(CAST(party_ref AS TEXT)), '') IS NOT NULL AND NULLIF(TRIM(CAST(lead_ref AS TEXT)), '') IS NOT NULL AND 1=1;
...
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(party_ref AS TEXT)), ''))), MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(account_ref AS TEXT)), ''))))) AS person_account_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(party_ref AS TEXT)), ''))) AS person_hash_key,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(account_ref AS TEXT)), ''))) AS account_hash_key
FROM crm_account_book_csv
WHERE NULLIF(TRIM(CAST(party_ref AS TEXT)), '') IS NOT NULL AND NULLIF(TRIM(CAST(account_ref AS TEXT)), '') IS NOT NULL AND 1=1;
...
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(customer_ref AS TEXT)), ''))), MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(party_ref AS TEXT)), ''))))) AS customer_person_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(customer_ref AS TEXT)), ''))) AS customer_hash_key,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(party_ref AS TEXT)), ''))) AS person_hash_key
FROM crm_customer_portfolio_csv
WHERE NULLIF(TRIM(CAST(customer_ref AS TEXT)), '') IS NOT NULL AND NULLIF(TRIM(CAST(party_ref AS TEXT)), '') IS NOT NULL AND 1=1;
...
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(customer_ref AS TEXT)), ''))), MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(lead_ref AS TEXT)), ''))))) AS customer_lead_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(customer_ref AS TEXT)), ''))) AS customer_hash_key,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(lead_ref AS TEXT)), ''))) AS lead_hash_key
FROM crm_customer_lead_bridge_csv
WHERE NULLIF(TRIM(CAST(customer_ref AS TEXT)), '') IS NOT NULL AND NULLIF(TRIM(CAST(lead_ref AS TEXT)), '') IS NOT NULL AND 1=1;
...
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(quote_ref AS TEXT)), ''))), MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(party_ref AS TEXT)), ''))))) AS quote_person_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(quote_ref AS TEXT)), ''))) AS quote_hash_key,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(party_ref AS TEXT)), ''))) AS person_hash_key
FROM crm_quote_register_csv
WHERE NULLIF(TRIM(CAST(quote_ref AS TEXT)), '') IS NOT NULL AND NULLIF(TRIM(CAST(party_ref AS TEXT)), '') IS NOT NULL AND 1=1;
...
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(quote_ref AS TEXT)), ''))), MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(product_ref AS TEXT)), ''))))) AS quote_product_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(quote_ref AS TEXT)), ''))) AS quote_hash_key,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(product_ref AS TEXT)), ''))) AS product_hash_key
FROM crm_quote_register_csv
WHERE NULLIF(TRIM(CAST(quote_ref AS TEXT)), '') IS NOT NULL AND NULLIF(TRIM(CAST(product_ref AS TEXT)), '') IS NOT NULL AND 1=1;
...
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(policy_ref AS TEXT)), ''))), MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(customer_ref AS TEXT)), ''))))) AS policy_customer_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(policy_ref AS TEXT)), ''))) AS policy_hash_key,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(customer_ref AS TEXT)), ''))) AS customer_hash_key
FROM crm_policy_register_csv
WHERE NULLIF(TRIM(CAST(policy_ref AS TEXT)), '') IS NOT NULL AND NULLIF(TRIM(CAST(customer_ref AS TEXT)), '') IS NOT NULL AND 1=1;
...
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(policy_ref AS TEXT)), ''))), MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(product_ref AS TEXT)), ''))))) AS policy_product_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(policy_ref AS TEXT)), ''))) AS policy_hash_key,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(product_ref AS TEXT)), ''))) AS product_hash_key
FROM crm_policy_register_csv
WHERE NULLIF(TRIM(CAST(policy_ref AS TEXT)), '') IS NOT NULL AND NULLIF(TRIM(CAST(product_ref AS TEXT)), '') IS NOT NULL AND 1=1
UNION ALL
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('SAP|', NULLIF(TRIM(CAST(policy_id AS TEXT)), ''))), MD5(CONCAT('SAP|', NULLIF(TRIM(CAST(product_id AS TEXT)), ''))))) AS policy_product_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'SAP' AS record_source,
    MD5(CONCAT('SAP|', NULLIF(TRIM(CAST(policy_id AS TEXT)), ''))) AS policy_hash_key,
    MD5(CONCAT('SAP|', NULLIF(TRIM(CAST(product_id AS TEXT)), ''))) AS product_hash_key
FROM sap_home_db
WHERE NULLIF(TRIM(CAST(policy_id AS TEXT)), '') IS NOT NULL AND NULLIF(TRIM(CAST(product_id AS TEXT)), '') IS NOT NULL AND 1=1
UNION ALL
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('SAP|', NULLIF(TRIM(CAST(policy_id AS TEXT)), ''))), MD5(CONCAT('SAP|', NULLIF(TRIM(CAST(product_id AS TEXT)), ''))))) AS policy_product_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
...
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(policy_ref AS TEXT)), ''))), MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(quote_ref AS TEXT)), ''))))) AS policy_quote_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(policy_ref AS TEXT)), ''))) AS policy_hash_key,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(quote_ref AS TEXT)), ''))) AS quote_hash_key
FROM crm_policy_register_csv
WHERE NULLIF(TRIM(CAST(policy_ref AS TEXT)), '') IS NOT NULL AND NULLIF(TRIM(CAST(quote_ref AS TEXT)), '') IS NOT NULL AND 1=1
UNION ALL
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_policy_id AS TEXT)), ''))), MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_quote_id AS TEXT)), ''))))) AS policy_quote_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_policy_id AS TEXT)), ''))) AS policy_hash_key,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_quote_id AS TEXT)), ''))) AS quote_hash_key
FROM crm_enhanced_policy_relationships_csv
WHERE NULLIF(TRIM(CAST(src_policy_id AS TEXT)), '') IS NOT NULL AND NULLIF(TRIM(CAST(src_quote_id AS TEXT)), '') IS NOT NULL AND source_extract = 'policy_quote_bridge.csv';
...
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_agent_id AS TEXT)), ''))), MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_person_id AS TEXT)), ''))))) AS broker_person_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_agent_id AS TEXT)), ''))) AS broker_hash_key,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_person_id AS TEXT)), ''))) AS person_hash_key
FROM crm_enhanced_person_relationships_csv
WHERE NULLIF(TRIM(CAST(src_agent_id AS TEXT)), '') IS NOT NULL AND NULLIF(TRIM(CAST(src_person_id AS TEXT)), '') IS NOT NULL AND source_extract = 'broker_person_bridge.csv';
...
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_person_id AS TEXT)), ''))), MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_campaign_id AS TEXT)), ''))))) AS person_campaign_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_person_id AS TEXT)), ''))) AS person_hash_key,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_campaign_id AS TEXT)), ''))) AS campaign_hash_key
FROM crm_enhanced_person_relationships_csv
WHERE NULLIF(TRIM(CAST(src_person_id AS TEXT)), '') IS NOT NULL AND NULLIF(TRIM(CAST(src_campaign_id AS TEXT)), '') IS NOT NULL AND source_extract = 'person_campaign_bridge.csv';
...
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_claim_id AS TEXT)), ''))), MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_policy_id AS TEXT)), ''))))) AS claim_policy_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_claim_id AS TEXT)), ''))) AS claim_hash_key,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_policy_id AS TEXT)), ''))) AS policy_hash_key
FROM crm_enhanced_policy_relationships_csv
WHERE NULLIF(TRIM(CAST(src_claim_id AS TEXT)), '') IS NOT NULL AND NULLIF(TRIM(CAST(src_policy_id AS TEXT)), '') IS NOT NULL AND source_extract = 'claim_policy_bridge.csv';
...
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_complaint_id AS TEXT)), ''))), MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_policy_id AS TEXT)), ''))))) AS complaint_policy_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_complaint_id AS TEXT)), ''))) AS complaint_hash_key,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_policy_id AS TEXT)), ''))) AS policy_hash_key
FROM crm_enhanced_policy_relationships_csv
WHERE NULLIF(TRIM(CAST(src_complaint_id AS TEXT)), '') IS NOT NULL AND NULLIF(TRIM(CAST(src_policy_id AS TEXT)), '') IS NOT NULL AND source_extract = 'complaint_policy_bridge.csv';
...
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_complaint_id AS TEXT)), ''))), MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_regulation_id AS TEXT)), ''))))) AS complaint_regulation_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_complaint_id AS TEXT)), ''))) AS complaint_hash_key,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_regulation_id AS TEXT)), ''))) AS regulation_hash_key
FROM crm_enhanced_policy_relationships_csv
WHERE NULLIF(TRIM(CAST(src_complaint_id AS TEXT)), '') IS NOT NULL AND NULLIF(TRIM(CAST(src_regulation_id AS TEXT)), '') IS NOT NULL AND source_extract = 'complaint_regulation_bridge.csv';
...
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_insured_object_id AS TEXT)), ''))), MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_home_id AS TEXT)), ''))))) AS insured_object_home_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_insured_object_id AS TEXT)), ''))) AS insured_object_hash_key,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_home_id AS TEXT)), ''))) AS home_hash_key
FROM crm_enhanced_policy_relationships_csv
WHERE NULLIF(TRIM(CAST(src_insured_object_id AS TEXT)), '') IS NOT NULL AND NULLIF(TRIM(CAST(src_home_id AS TEXT)), '') IS NOT NULL AND source_extract = 'insured_object_home_bridge.csv';
...
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_insured_object_id AS TEXT)), ''))), MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_motor_id AS TEXT)), ''))))) AS insured_object_motor_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_insured_object_id AS TEXT)), ''))) AS insured_object_hash_key,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_motor_id AS TEXT)), ''))) AS motor_hash_key
FROM crm_enhanced_policy_relationships_csv
WHERE NULLIF(TRIM(CAST(src_insured_object_id AS TEXT)), '') IS NOT NULL AND NULLIF(TRIM(CAST(src_motor_id AS TEXT)), '') IS NOT NULL AND source_extract = 'insured_object_motor_bridge.csv';
...
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_policy_id AS TEXT)), ''))), MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_agent_id AS TEXT)), ''))))) AS policy_broker_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_policy_id AS TEXT)), ''))) AS policy_hash_key,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_agent_id AS TEXT)), ''))) AS broker_hash_key
FROM crm_enhanced_policy_relationships_csv
WHERE NULLIF(TRIM(CAST(src_policy_id AS TEXT)), '') IS NOT NULL AND NULLIF(TRIM(CAST(src_agent_id AS TEXT)), '') IS NOT NULL AND source_extract = 'policy_broker_bridge.csv';
...
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_policy_id AS TEXT)), ''))), MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_channel_id AS TEXT)), ''))))) AS policy_channel_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_policy_id AS TEXT)), ''))) AS policy_hash_key,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_channel_id AS TEXT)), ''))) AS channel_hash_key
FROM crm_enhanced_policy_relationships_csv
WHERE NULLIF(TRIM(CAST(src_policy_id AS TEXT)), '') IS NOT NULL AND NULLIF(TRIM(CAST(src_channel_id AS TEXT)), '') IS NOT NULL AND source_extract = 'policy_channel_bridge.csv';
...
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_policy_id AS TEXT)), ''))), MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_insured_object_id AS TEXT)), ''))))) AS policy_insured_object_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_policy_id AS TEXT)), ''))) AS policy_hash_key,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_insured_object_id AS TEXT)), ''))) AS insured_object_hash_key
FROM crm_enhanced_policy_relationships_csv
WHERE NULLIF(TRIM(CAST(src_policy_id AS TEXT)), '') IS NOT NULL AND NULLIF(TRIM(CAST(src_insured_object_id AS TEXT)), '') IS NOT NULL AND source_extract = 'policy_insured_object_bridge.csv';
...
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_policy_id AS TEXT)), ''))), MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_override_id AS TEXT)), ''))))) AS policy_override_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_policy_id AS TEXT)), ''))) AS policy_hash_key,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_override_id AS TEXT)), ''))) AS override_hash_key
FROM crm_enhanced_policy_relationships_csv
WHERE NULLIF(TRIM(CAST(src_policy_id AS TEXT)), '') IS NOT NULL AND NULLIF(TRIM(CAST(src_override_id AS TEXT)), '') IS NOT NULL AND source_extract = 'policy_override_bridge.csv';
...
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_quote_id AS TEXT)), ''))), MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_agent_id AS TEXT)), ''))))) AS quote_broker_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_quote_id AS TEXT)), ''))) AS quote_hash_key,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_agent_id AS TEXT)), ''))) AS broker_hash_key
FROM crm_enhanced_policy_relationships_csv
WHERE NULLIF(TRIM(CAST(src_quote_id AS TEXT)), '') IS NOT NULL AND NULLIF(TRIM(CAST(src_agent_id AS TEXT)), '') IS NOT NULL AND source_extract = 'quote_broker_bridge.csv';
...
SELECT DISTINCT
    MD5(CONCAT_WS('|', MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_quote_id AS TEXT)), ''))), MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_channel_id AS TEXT)), ''))))) AS quote_channel_hash_key,
    COALESCE(NULLIF(TRIM(CAST(pull_ts AS TEXT)), ''), CURRENT_TIMESTAMP) AS load_date,
    'CRM' AS record_source,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_quote_id AS TEXT)), ''))) AS quote_hash_key,
    MD5(CONCAT('CRM|', NULLIF(TRIM(CAST(src_channel_id AS TEXT)), ''))) AS channel_hash_key
FROM crm_enhanced_policy_relationships_csv
WHERE NULLIF(TRIM(CAST(src_quote_id AS TEXT)), '') IS NOT NULL AND NULLIF(TRIM(CAST(src_channel_id AS TEXT)), '') IS NOT NULL AND source_extract = 'quote_channel_bridge.csv';

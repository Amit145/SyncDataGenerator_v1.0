...
def render_query(query: str, view_name: str, pk_cols: list[str], bk_cols: list[str], target_filter: str) -> str:
    return query.format(
...
def run_sql_quality(obj: dict[str, Any], rule: dict[str, Any], view_name: str, entity_config: dict[str, Any]) -> None:
    ...
    query = render_query(rule["query"], view_name, pk_cols, bk_cols, target_filter)

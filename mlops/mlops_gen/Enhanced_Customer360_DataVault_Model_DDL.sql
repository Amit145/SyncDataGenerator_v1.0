...
CREATE TABLE hub_insured_object
(
...
(
	complaint_policy_hash_key STRING NOT NULL,
	load_date TIMESTAMP,
	record_source STRING,
	complaint_hash_key STRING NOT NULL,
	policy_hash_key STRING NOT NULL
...
(
	complaint_regulation_hash_key STRING NOT NULL,
	load_date TIMESTAMP,
	record_source STRING,
	regulation_hash_key STRING NOT NULL,
	complaint_hash_key STRING NOT NULL
...
CREATE TABLE link_insured_object_home
(
...
CREATE TABLE link_policy_broker
(
...
CREATE TABLE link_policy_insured_object
(
...
CREATE TABLE link_policy_quote
(
...
(
	quote_broker_hash_key STRING NOT NULL,
	load_date TIMESTAMP,
	record_source STRING,
	quote_hash_key STRING NOT NULL,
	broker_hash_key STRING NOT NULL
...
ALTER TABLE link_quote_broker
	ADD CONSTRAINT XPKlink_quote_broker PRIMARY KEY (quote_broker_hash_key);

CREATE TABLE link_quote_channel
(
	quote_channel_hash_key STRING NOT NULL,
	load_date TIMESTAMP,
	record_source STRING,
	quote_hash_key STRING NOT NULL,
	channel_hash_key STRING NOT NULL
...
(
	...
	number_of_email_bounced INT,
	number_of_emails_delivered INT,
...
(
	...
	claim_settlement_date TIMESTAMP,
	...
	litigation_start_date TIMESTAMP,
	litigation_end_date TIMESTAMP,
...
CREATE TABLE sat_insured_object
(
	insured_object_hash_key STRING NOT NULL,
	load_date TIMESTAMP NOT NULL,
...
(
	...
	regulation_date_raised TIMESTAMP,
	regulation_date_closed TIMESTAMP,
	regulation_owner STRING,
	regulation_deadline_date TIMESTAMP,
...
ALTER TABLE link_complaint_policy
	ADD CONSTRAINT R_68 FOREIGN KEY (complaint_hash_key) REFERENCES hub_complaint (complaint_hash_key);

ALTER TABLE link_complaint_policy
	ADD CONSTRAINT R_89 FOREIGN KEY (policy_hash_key) REFERENCES hub_policy (policy_hash_key);

ALTER TABLE link_complaint_regulation
	ADD CONSTRAINT R_70 FOREIGN KEY (regulation_hash_key) REFERENCES hub_regulation (regulation_hash_key);

ALTER TABLE link_complaint_regulation
	ADD CONSTRAINT R_90 FOREIGN KEY (complaint_hash_key) REFERENCES hub_complaint (complaint_hash_key);
...
ALTER TABLE link_insured_object_home
	ADD CONSTRAINT R_84 FOREIGN KEY (insured_object_hash_key) REFERENCES hub_insured_object (insured_object_hash_key);

ALTER TABLE link_insured_object_home
	ADD CONSTRAINT R_86 FOREIGN KEY (home_hash_key) REFERENCES hub_home (home_hash_key);

ALTER TABLE link_insured_object_motor
	ADD CONSTRAINT R_83 FOREIGN KEY (insured_object_hash_key) REFERENCES hub_insured_object (insured_object_hash_key);

ALTER TABLE link_insured_object_motor
	ADD CONSTRAINT R_85 FOREIGN KEY (motor_hash_key) REFERENCES hub_motor (motor_hash_key);
...
ALTER TABLE link_policy_broker
	ADD CONSTRAINT R_95 FOREIGN KEY (broker_hash_key) REFERENCES hub_broker (broker_hash_key);

ALTER TABLE link_policy_broker
	ADD CONSTRAINT R_96 FOREIGN KEY (policy_hash_key) REFERENCES hub_policy (policy_hash_key);
...
ALTER TABLE link_policy_insured_object
	ADD CONSTRAINT R_87 FOREIGN KEY (insured_object_hash_key) REFERENCES hub_insured_object (insured_object_hash_key);

ALTER TABLE link_policy_insured_object
	ADD CONSTRAINT R_88 FOREIGN KEY (policy_hash_key) REFERENCES hub_policy (policy_hash_key);
...
ALTER TABLE link_policy_quote
	ADD CONSTRAINT R_92 FOREIGN KEY (quote_hash_key) REFERENCES hub_quote (quote_hash_key);

ALTER TABLE link_policy_quote
	ADD CONSTRAINT R_93 FOREIGN KEY (policy_hash_key) REFERENCES hub_policy (policy_hash_key);

ALTER TABLE link_quote_broker
	ADD CONSTRAINT R_97 FOREIGN KEY (quote_hash_key) REFERENCES hub_quote (quote_hash_key);

ALTER TABLE link_quote_broker
	ADD CONSTRAINT R_100 FOREIGN KEY (broker_hash_key) REFERENCES hub_broker (broker_hash_key);

ALTER TABLE link_quote_channel
	ADD CONSTRAINT R_91 FOREIGN KEY (quote_hash_key) REFERENCES hub_quote (quote_hash_key);

ALTER TABLE link_quote_channel
	ADD CONSTRAINT R_94 FOREIGN KEY (channel_hash_key) REFERENCES hub_channel (channel_hash_key);
...
ALTER TABLE sat_complaint
	ADD CONSTRAINT R_62 FOREIGN KEY (complaint_hash_key) REFERENCES hub_complaint (complaint_hash_key);
...
ALTER TABLE sat_regulation
	ADD CONSTRAINT R_57 FOREIGN KEY (regulation_hash_key) REFERENCES hub_regulation (regulation_hash_key);
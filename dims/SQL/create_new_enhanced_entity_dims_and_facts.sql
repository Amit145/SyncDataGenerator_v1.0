-- Dimensional DDL for newly added enhanced entities: dimensions and fact.
...
--   Fact:       fact_complaint
-- Column names, order, data types, and PK markers follow the S2T workbook.
...
(
    person_sk BIGINT,
    customer_sk BIGINT,
    regulation_sk BIGINT,
    channel_sk BIGINT,
    date_sk BIGINT,
    insured_object_sk CHAR(18),
    person_id STRING,
    complaint_id STRING,
    complaint_date DATE,
